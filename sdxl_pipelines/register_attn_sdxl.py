...
"""
source: https://github.com/huggingface/diffusers/blob/v0.35.1/src/diffusers/pipelines/stable_diffusion_xl/pipeline_stable_diffusion_xl.py
...
class RegisterAttnSDXL(
    ...
    r"""
    Pipeline for text-to-image generation using Stable Diffusion XL with registered attention maps.
    ...
    def __call__(
        ...
        register_attn_res: Optional[Tuple[int, int]] = (32, 32),
        ...
        **kwargs,
        ...
        Args:
            ...
            register_attn_res (`Tuple[int, int]`, *optional*, defaults to `(32, 32)`):
                Attention resolution used when registering attention control.
            progress_to_save_attn (`float`, *optional*):
                Fraction of the denoising schedule after which saved attention maps are stored.
        ...
        # 10. register attention resolution for attention maps
        if register_attn_res is not None:
            register_attention_control(self, attn_res=register_attn_res)
